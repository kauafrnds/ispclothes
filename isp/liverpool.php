...
<li>  <a href="carrinho.php" class="cart-btn">🛒 Carrinho</a>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="imagens/liverpool.png" alt="Camisa Flamengo" id="product-image">
        </div>
        <div class="product-info">
            <h1>Camisa Liverpool I 24/25 s/n° Torcedor Nike Masculina</h1>
  ...
  <br><br><br><br><br><br><br><br><br><br>
    ...
    function addToCart(imageSrc) {
        ...
        cart.push({
            name: "Camisa Liverpool I 24/25 s/n° Torcedor Nike Masculina",
            price: 149.90,
            image: imageSrc
        });
