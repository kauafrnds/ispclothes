...
<li>  <a href="carrinho.php" class="cart-btn">🛒 Carrinho</a>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="imagens/city.png" alt="Camisa Flamengo" id="product-image">
        </div>
        <div class="product-info">
            <h1>Camisa Manchester City I 24/25 s/n° Torcedor Puma Masculina</h1>
            ...
            <div class="product-specifications">
                ...
                <div class="spec-item"><strong>Modelo:</strong> Torcedor Puma</div>
                <div class="spec-item"><strong>Marca:</strong> Puma</div>
  ...
  <br><br><br><br><br><br><br><br><br><br>
    ...
    function addToCart(imageSrc) {
        ...
        cart.push({
            name: "Camisa Manchester City I 24/25 s/n° Torcedor Puma Masculina",
            price: 199.90,
            image: imageSrc
        });
