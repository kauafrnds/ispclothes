...
<li>  <a href="carrinho.php" class="cart-btn">🛒 Carrinho</a>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="imagens/flu.png" alt="Camisa Flamengo" id="product-image">
        </div>
        <div class="product-info">
            <h1>Camisa Fluminense I 24/25 s/n° Torcedor Umbro Masculina</h1>
            ...
            <div class="product-specifications">
                ...
                <div class="spec-item"><strong>Modelo:</strong> Torcedor Umbro</div>
                <div class="spec-item"><strong>Marca:</strong> Umbro</div>
  ...
  <br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    function addToCart(imageSrc) {
        ...
        cart.push({
            name: "Camisa Fluminense I 24/25 s/n° Torcedor Umbro Masculina",
            price: 199.90,
            image: imageSrc
        });
