...
<li>  <a href="carrinho.php" class="cart-btn">🛒 Carrinho</a>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="imagens/holanda.png" alt="Camisa Flamengo" id="product-image">
        </div>
        <div class="product-info">
            <h1>Camisa Holanda I 24/25 s/n° Torcedor Nike Masculina</h1>
            <p class="price">R$ 179,90 <span class="discount">(Desconto de 10%)</span></p>
            <div class="ratings">
  ...
  <br><br><br><br><br><br><br><br><br><br>
    ...
    function addToCart(imageSrc) {
        ...
        cart.push({
            name: "Camisa Holanda I 24/25 s/n° Torcedor Nike Masculina",
            price: 179.90,
            image: imageSrc
        });
