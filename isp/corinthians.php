...
<li>  <a href="carrinho.php" class="cart-btn">🛒 Carrinho</a>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="imagens/corinthians.png" alt="Camisa Flamengo" id="product-image">
        </div>
        <div class="product-info">
            <h1>Camisa Corinthians I 24/25 s/n° Torcedor Nike Masculina</h1>
            <p class="price">R$ 149,90 <span class="discount">(Desconto de 10%)</span></p>
            <div class="ratings">
            ...
            <div class="product-specifications">
                ...
                <div class="spec-item"><strong>Modelo:</strong> Torcedor Nike</div>
                <div class="spec-item"><strong>Marca:</strong> Nike</div>
  ...
  <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    function addToCart(imageSrc) {
        ...
        cart.push({
            name: "Camisa Corinthians I 24/25 s/n° Torcedor Nike Masculina",
            price: 149.90,
            image: imageSrc
        });
